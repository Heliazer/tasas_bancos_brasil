      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium" style={{ color: '#F4E4A3' }}>Plataforma Profissional de Simulação Financeira</p>
                  </div>
                </div>
        ...
        {results && (
          <div id="results" className="scroll-mt-8">
            <div
              className="mb-6 rounded-xl p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative overflow-hidden"
              style={{
                background: 'linear-gradient(135deg, #002776 0%, #003893 100%)',
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-xl font-bold text-white mb-1" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.3)' }}>
                  Resultados da Simulação
                </h2>
                <p className="text-sm font-medium" style={{ color: '#F4E4A3' }}>Análise completa da sua operação de factoring</p>
              </div>
              <button
                onClick={handleNewSimulation}
                className="btn-secondary whitespace-nowrap relative z-10"
              >
                Nova Simulação
              </button>
            </div>
        ...
        {/* Footer */}
        <footer className="mt-16 pt-8" style={{ borderTop: '2px solid #B0BEC5' }}>
          <div
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-3">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style={{ color: '#D4A017' }}>
            ...
            <p className="text-xs leading-relaxed max-w-2xl mx-auto" style={{ color: '#546E7A' }}>
            ...
            <div className="mt-4 pt-4" style={{ borderTop: '1px solid #CFD8DC' }}>
